...
class Rectangle:
    """
    Rectangle class
    Public attributes: number of instances, print_symbol
...
# Public instance method area and perimeter
    ...
    def __str__(self):
        """ This method print the rectangle with the
        symbol given as public attribute of class.
        The attribute could be any type, so it is necessary to cast
        to string
        """
        rect = ""
